...
export default function Home() {
  return (
    <div className='px-customPaddingMobile md:px-customPadding '>
      <div className='flex flex-col space-y-2 mt-24 md:mt-28 px-customPaddingMobile items-start justify-center'>
        <h1 className='font-sora text-purple-950 font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl animate-topToBottom'>
          Triveda
        </h1>
