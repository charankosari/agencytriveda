...
export default function About() {
  ...
  return (
    ...
    >
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-10 text-gray-100 font-sora">
        Discover Who We Are
      </h1>
      <div className='flex flex-col md:flex-row w-full md:space-x-8 space-y-8 md:space-y-0 items-center'>
        <div className='flex flex-col text-md md:text-sm lg:text-lg items-center md:items-center lg:items-start text-gray-300 font-body md:w-1/2'>
