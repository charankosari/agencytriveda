...
export default function About() {
  ...
  return (
    <div
      ref={aboutRef}
      className={`flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 xl:px-16 2xl:px-24 w-full 
                  transition-transform duration-700 ${isInView ? 'animate-fadeInUp' : 'translate-y-10 opacity-0'}`}
    >
      <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-center mb-10 md:mb-12 lg:mt-32 text-gray-100 font-sora">
        Discover Who We Are
      </h1>
        ...
        <div className='flex justify-center md:justify-end md:w-1/2'>
          <img
            className='rounded-md w-full max-w-full h-auto object-cover shadow-md 
                       max-h-[350px] sm:max-h-[400px] md:max-h-[450px] lg:max-h-[570px] xl:max-h-[650px] 2xl:max-h-[750px]'
            src={Founders}
            alt="Triveda Team"
          />
        </div>
