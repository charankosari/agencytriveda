    ...
    <footer className="bg-black text-white border-t border-gray-800 py-16 font-sora xl:px-12 1.5xl:px-20 2xl:px-96">
      <div className="max-w-screen mx-auto px-6  ">
        ...
        <div className="flex flex-col items-start lg:items-start  lg:text-left mb-12">
          ...
          <Link to="/contact" className="block hover:text-red-600 transition-colors duration-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 mb-12">
          ...
          <div className="flex flex-col items-startlg:items-start  lg:text-left">
            <img src={Logo} alt="Triveda Logo" className="w-32 h-32 lg:w-48 lg:h-48 mb-4" />
